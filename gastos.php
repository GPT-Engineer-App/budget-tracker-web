...
$query = "SELECT * FROM transacao WHERE tipo='gasto' AND idConta IN (SELECT id FROM conta WHERE emailUsuario='{$_SESSION['email']}')";
...
<body>
    <div class="container">
        ...
        <a href="add_gasto.php" class="btn">Adicionar Gasto</a>
    </div>
    <script>
